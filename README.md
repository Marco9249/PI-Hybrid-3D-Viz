...
> **🔌 Fully Offline:** All assets (Three.js, GSAP, fonts, KaTeX, React) are vendored locally. No internet connection required.
...
![Status](https://img.shields.io/badge/Status-Research_Active-success?style=flat-square&logo=github) ![License](https://img.shields.io/badge/License-MIT-blue?style=flat-square) ![Offline](https://img.shields.io/badge/Offline-Ready-brightgreen?style=flat-square&logo=wifi-off)
